...
export type Category = 'development' | 'administration' | 'design' | 'managment' | 'marketing'
...
export type CommentAuthor = Omit<PublicUser, 'about' | 'registrationDate' | 'id' | 'rating' | 'subscriptions' | 'publications' | 'links'>

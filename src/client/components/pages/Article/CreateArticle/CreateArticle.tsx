      ...
      >
        <div className={cnCreateArticle("Container")}>
          <div className={cnCreateArticle("Wrapper")}>
            ...
            <Title level={4}>
              Здесь напишите превью-контент вашей статьи (его пользователи будут
              видеть перед тем, как перейдет к вашей статье)
            </Title>
            <Editor />
            <Title level={4}>
              Основной контент вашей статьи (будет совмещен с превью-контентом)
            </Title>
            <Editor />
            <Form.Item
              name="tags"
              ...
              rules={[
                {
                  required: true,
                  message: "Укажите хотя бы один тег",
                },
              ]}
            >
            ...
            <Button block htmlType="submit" type="primary">
              Отправить на проверку модерации
            </Button>
          </div>
        </div>
      </Form>
